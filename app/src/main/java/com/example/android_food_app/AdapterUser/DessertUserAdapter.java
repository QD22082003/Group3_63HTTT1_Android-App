...
public class DessertUserAdapter extends RecyclerView.Adapter<DessertUserAdapter.TrangMiengViewHolder >{
    private List<SanPham> listtrangmieng;
    private Context mContext;

    public DessertUserAdapter(List<SanPham> listtrangmieng, Context mContext) {
    ...
    public TrangMiengViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new DessertUserAdapter.TrangMiengViewHolder(view);
    }
