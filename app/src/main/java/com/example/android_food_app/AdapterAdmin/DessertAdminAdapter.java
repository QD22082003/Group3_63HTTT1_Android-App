...
import com.example.android_food_app.ActivityAdmin.DetailProductDessertAdminActivity;
...
public class DessertAdminAdapter extends RecyclerView.Adapter<DessertAdminAdapter.DessertViewHolder> {
    ...
    public DessertAdminAdapter(Context mContext, List<Product> mListProduct) {
    ...
    public void onBindViewHolder(@NonNull DessertViewHolder holder, int position) {
        ...
        holder.recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, DetailProductDessertAdminActivity.class);
