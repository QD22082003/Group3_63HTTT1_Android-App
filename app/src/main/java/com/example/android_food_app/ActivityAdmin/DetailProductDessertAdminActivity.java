...
public class DetailProductDessertAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_product_dessert_admin);
        ...
        edt_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DetailProductDessertAdminActivity.this, UpdateDessertAdminActivity.class);
    ...
    private void deleteProduct() {
        ...
        databaseReference.removeValue().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(DetailProductDessertAdminActivity.this, "Xóa sản phẩm khỏi Realtime Database thất bại: " + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void deleteImageFromStorageAndFinish(String imageUrl) {
        ...
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Toast.makeText(DetailProductDessertAdminActivity.this, "Xóa sản phẩm thành công", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(getApplicationContext(), DessertPageAdminActivity.class));
                finish();
            }
        });
    }
