...
public class AddDessertAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_dessert_admin);
        ...
        currentIdReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AddDessertAdminActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
                ...
                new ActivityResultCallback<ActivityResult>() {
                    ...
                    public void onActivityResult(ActivityResult result) {
                        if (result.getResultCode() == Activity.RESULT_OK) {
                            ...
                            Toast.makeText(AddDessertAdminActivity.this, "Không có hình ảnh nào được chọn", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
        );
    ...
    private void saveMainImage() {
        if (uriMainImage == null) {
            Toast.makeText(AddDessertAdminActivity.this, "Vui lòng chọn hình ảnh chính", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AddDessertAdminActivity.this);
        ...
        storageReference.putFile(uriMainImage).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                dialog.dismiss();
                Toast.makeText(AddDessertAdminActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveSliderImage(AlertDialog dialog) {
        if (uriSliderImage == null) {
            Toast.makeText(AddDessertAdminActivity.this, "Vui lòng chọn hình ảnh slider", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
            return;
        }
    ...
    private void saveOtherImage(AlertDialog dialog) {
        if (uriOtherImage == null) {
            Toast.makeText(AddDessertAdminActivity.this, "Vui lòng chọn hình ảnh khác", Toast.LENGTH_SHORT).show();
            dialog.dismiss();
            return;
        }
...
//            Product product = new Product(name, desc, price, priceNewFormatted, sale, imgMainURL, imgSliderURL, popular, productType, imgOtherURL);
                    ...
                    .setValue(product).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(AddDessertAdminActivity.this, "Thêm sản phẩm thành công", Toast.LENGTH_SHORT).show();
                                dialog.dismiss();
                                Intent intent = new Intent(AddDessertAdminActivity.this, DessertPageAdminActivity.class);
            ...
            dialog.dismiss();
            Toast.makeText(AddDessertAdminActivity.this, "Đã xảy ra lỗi: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
